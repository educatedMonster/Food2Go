...
import com.example.food2go.constants.PusherConst.ORDER_ID
import com.example.food2go.constants.PusherConst.MERCHANT_ID
import com.example.food2go.screens.main.MainActivity
import com.example.food2go.screens.splash.SplashActivity
    ...
    private fun getChannelNotification(
        ...
        val pendingIntent = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            PendingIntent.getActivity(
                baseContext, 0, intent,PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
            )
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            PendingIntent.getActivity(
                baseContext, 0, intent,PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_MUTABLE
            )
        } else {
