package com.example.food2go.screens.product_and_inventory.inventory.dialogs
...
import com.example.food2go.databinding.DialogBottomProductSearchBinding
...
import com.example.food2go.screens.product_and_inventory.inventory.adapter.ProductSearchAdapter
    ...
    private fun initLiveData() {
        inventoryViewModel.apply {
            ...
            isAddedInventory.observe(binding.lifecycleOwner!!) {
                ...
                (com.example.food2go.utilities.getDialog(requireActivity(),
